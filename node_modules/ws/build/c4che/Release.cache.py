...
CPPPATH_NODE = '/usr/local/Cellar/node/0.8.19/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
...
LIBDIR = '/Users/epintor/.node_libraries'
LIBPATH_NODE = '/usr/local/Cellar/node/0.8.19/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-O3', '-arch', 'x86_64']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/epintor/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.8.19'
