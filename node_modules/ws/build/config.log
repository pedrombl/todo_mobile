# project noname (0.4.8) configured on Sun Mar 10 16:47:58 2013 by
# waf 1.5.16 (abi 7, python 20702f0 on darwin)
# using /usr/local/Cellar/node/0.8.19/bin/node-waf configure build
#
...
ok /usr/local/Cellar/node/0.8.19
